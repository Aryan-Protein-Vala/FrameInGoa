      ...
      <section id="generator" className="relative border-y-2 border-foreground bg-primary px-5 py-12 md:px-12 md:py-16">
        ...
        <div className="mx-auto grid max-w-7xl gap-10 md:grid-cols-[0.8fr_1.2fr] md:gap-20 relative z-10">
          ...
          <div className="grid gap-5">
            ...
            <label className="font-mono text-[10px] font-black uppercase">Builder class<input list="builder-classes" value={form.className} onChange={(e) => update('className', e.target.value)} placeholder="Select or type a class..." className="mt-2 w-full border-2 border-foreground bg-background px-3 py-3 font-mono text-sm font-bold outline-none focus:ring-2 focus:ring-foreground" /><datalist id="builder-classes"><option value="BUILDER CLASS" /><option value="10X ENGINEER" /><option value="VIBE CODER" /><option value="FULLSTACK ALCHEMIST" /><option value="EDGE LORD" /><option value="AI WRANGLER" /><option value="DESIGN ENGINEER" /><option value="PROTOCOL ARCHITECT" /><option value="0 TO 1 SPECIALIST" /><option value="PIXEL PERFECTOR" /><option value="INFRA WIZARD" /></datalist></label>
