            ...
            <label className="font-mono text-[10px] font-black uppercase">Builder class
              {isCustomClass ? (
                ...
                <select 
                  ...
                  className="mt-2 w-full border-2 border-foreground bg-background px-3 py-3 font-mono text-sm font-bold outline-none focus:ring-2 focus:ring-foreground appearance-none rounded-none cursor-pointer"
                >
                  <option value="BUILDER CLASS">Select a class...</option>
                  <option value="10X ENGINEER">10x Engineer</option>
                  <option value="VIBE CODER">Vibe Coder</option>
                  <option value="FULLSTACK ALCHEMIST">Fullstack Alchemist</option>
                  <option value="EDGE LORD">Edge Lord</option>
                  <option value="AI WRANGLER">AI Wrangler</option>
                  <option value="DESIGN ENGINEER">Design Engineer</option>
                  <option value="PROTOCOL ARCHITECT">Protocol Architect</option>
                  <option value="0 TO 1 SPECIALIST">0 to 1 Specialist</option>
                  <option value="PIXEL PERFECTOR">Pixel Perfector</option>
                  <option value="INFRA WIZARD">Infra Wizard</option>
                  <option value="OTHER...">Other (Custom)...</option>
                </select>
              )}
            </label>
