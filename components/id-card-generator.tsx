      ...
      <section id="top" className="mx-auto grid max-w-7xl gap-10 px-5 py-12 md:grid-cols-[1.05fr_0.95fr] md:gap-16 md:px-12 md:py-20">
        ...
        <div className="relative flex min-h-[330px] items-center justify-center md:min-h-[440px]">
          <div className="card-paper pencil-card relative w-[min(82vw,300px)] aspect-[2/3] rotate-[4deg] shadow-[10px_10px_0_var(--primary)] overflow-hidden bg-[#f4f0df] rounded-2xl border-2 border-foreground">
            ...
            {photo ? (
              <img src={photo} alt="Uploaded builder" className="absolute top-[8%] left-[8%] w-[84%] h-[66%] object-cover grayscale z-0" />
            ) : (
              <div className="absolute top-[8%] left-[8%] w-[84%] h-[66%] bg-[#ebd90b] flex flex-col items-center justify-center gap-2 font-mono text-center z-0">
      ...
      <section id="result-section" className="mx-auto max-w-7xl px-5 py-12 md:px-12 md:py-20">
        ...
        <div className="mt-10 grid place-items-center border-2 border-dashed border-primary bg-transparent p-6 relative overflow-hidden">
          ...
          >
            {/* User Photo Base Layer */}
            {photo ? (
              <img src={photo} alt="Generated builder card" className="absolute top-[8%] left-[8%] w-[84%] h-[66%] object-cover grayscale z-0" />
            ) : (
              <div className="absolute top-[8%] left-[8%] w-[84%] h-[66%] bg-[#ebd90b] flex items-center justify-center font-mono text-[10px] font-bold uppercase text-center z-0">
  ...
  if (photo) { 
    await new Promise((resolve) => {
      ...
      image.onload = () => { 
        ...
        // photo box: top 8%, left 8%, width 84%, height 66%
        context.drawImage(image, 82, 123, 860, 1000);
        context.filter = 'none';
        resolve(true);
      }; 
      image.src = photo 
    ...
    context.fillRect(82, 123, 860, 1000);
  }
