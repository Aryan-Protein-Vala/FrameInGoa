      ...
      <section id="generator" className="border-y-2 border-foreground bg-primary px-5 py-12 md:px-12 md:py-16">
        <div className="mx-auto grid max-w-7xl gap-10 md:grid-cols-[0.8fr_1.2fr] md:gap-20">
          ...
          <div className="grid gap-5">
            ...
            <button onClick={generate} disabled={!photo} className="w-full border-2 border-foreground bg-[#0B6839] px-6 py-4 font-mono text-xs font-black uppercase tracking-[0.2em] text-[#f4f0df] disabled:opacity-50">{generated ? 'CARD GENERATED ✓' : 'GENERATE MY ID CARD ↗'}</button>
          </div>
        </div>
      </section>
